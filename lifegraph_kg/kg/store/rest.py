...
class RestStore:
    ...
    def save_episode(
        ...
        ep_row = {
            ...
            "duration_inferred": episode.duration_inferred,
            "origin_tz": episode.origin_tz,
            "time_mode": episode.time_mode,
            "wall_clock_hour": episode.wall_clock_hour,
            "wall_clock_minute": episode.wall_clock_minute,
